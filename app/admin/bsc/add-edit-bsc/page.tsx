...
export default async function Page({ searchParams }: PageProps) {
	...
	const { bSc, organizationContext, position } = await getBscOrganizationContextPositionByIds({
		bscId,
		organizationId,
		positionId,
		year
	...
	return (
		<main className="min-h-screen bg-background">
			<BSCForm bSC={bSc} organizationContext={organizationContext} position={position} year={year} />
		</main>
	);
}
