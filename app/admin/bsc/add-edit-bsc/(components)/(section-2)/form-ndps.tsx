				...
				render={() => (
					<FormItem>
						<FormLabel className="flex items-center justify-between gap-2">
							<span>
								NDP programmes <span className="text-xs text-muted-foreground">({watchedValues?.length})</span>
							</span>
							<LoadingButton
								loading={isFetching}
								type="button"
							...
							>
								<StarsIcon />
								<span className="sr-only">Let Ai get Ndp Programmes for you</span>
							</LoadingButton>
						</FormLabel>
						<Form {...form2}>
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										{isPending && <FormDescription>Ai is getting your NDP programmes...</FormDescription>}
										<FormMessage>
											{isError &&
