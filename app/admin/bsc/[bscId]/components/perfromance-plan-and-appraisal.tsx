...
export default function PerformancePlanAndAppraisal({
  ...
  const totalScore = performanceObjectives.reduce(
        ...
        <Table>
          ...
          <TableBody>
            {!groupedPerspectives.length ? (
              <EmptyContainer
                message={"There are no performance objectives defined."}
              />
            ) : (
              <>
                    ...
                    <TableRow key={obj.objective} className="*:align-top">
                      ...
                      {index === 0 && (
                        ...
                        >
                          ...
                          {p.perspective ===
                            perspectives[
                              PerspectiveType.STAKEHOLDERS_CLIENTS
                            ] && <p>({clients.join(", ")})</p>}
                        </TableCell>
                      )}
