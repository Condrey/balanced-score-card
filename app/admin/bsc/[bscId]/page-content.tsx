...
export default function PageContent({ bsc }: PageContentProps) {
	return (
		<div className="space-y-6 *:mx-auto *:w-full">
			...
			<SuperviseeSupervisorParticulars supervisee={bsc.supervisee} supervisor={bsc.supervisor} />
			{/* SECTION 2: BSC STRATEGIC ELEMENTS */}
			<StrategicElements bsc={bsc} />
			{/* SECTION 3: PERFORMANCE PLAN AND PERFORMANCE APPRAISAL */}
			<PerformancePlanAndAppraisal performanceObjectives={bsc.performanceObjectives} clients={bsc.clients} />
