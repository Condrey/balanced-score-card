...
import { behavioralAttributeSchema, type BehavioralAttributeSchema } from "@/lib/validations/bsc";
...
export function FormAddEditBehavioralAttribute({
	...
	return (
		<ResponsiveDrawer
			open={open}
			setOpen={setOpen}
			title={`${behavioralAttribute ? `Edit "${behavioralAttribute.attribute}"` : "Create"} behavioral attribute`}
			description={
				behavioralAttribute
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<Input placeholder="Enter behavioral attribute" disabled {...field} />
								</FormControl>
								<FormMessage />
							</FormItem>
						)}
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<Input
										placeholder={`Enter score for the ${form.watch("attribute")} behavioral attribute`}
										disabled
										{...field}
									/>
								</FormControl>
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<Textarea
										placeholder={`Enter description for ${form.watch("attribute")} behavioral attribute`}
										rows={4}
										{...field}
									/>
								</FormControl>
