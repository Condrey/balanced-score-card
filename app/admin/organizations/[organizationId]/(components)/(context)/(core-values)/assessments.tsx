...
import { behavioralAttributeSchema, BehavioralAttributeSchema, BSCFormData } from "@/lib/validations/bsc";
					...
					<FormItem>
						<div className="grid gap-4">
											...
											<Popover>
												<PopoverTrigger asChild>
													<FormControl>
														...
														>
															{field.value
																? coreValuesList.find((d) => d.value === field.value)?.value
													...
													<Command>
														...
														<CommandList>
															<CommandEmpty className="flex max-w-[200px] flex-row justify-center text-center text-xs text-muted-foreground">
																No attribute found. Please add core values to populate!
															</CommandEmpty>
															<CommandGroup>
																{coreValuesList.map((d) => (
																	...
																	>
																		{d.value}
																		<CheckIcon
																			className={cn("ml-auto", d.value === field.value ? "opacity-100" : "opacity-0")}
																		/>
																	</CommandItem>
																))}
															</CommandGroup>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem className="">
											...
											<FormControl>
												<NumberInput min="0" max="20" step="0.1" placeholder="Enter percentage" {...field} />
											</FormControl>
										</FormItem>
									)}
								/>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Textarea placeholder="Describe the behavioral attribute" rows={2} {...field} />
										</FormControl>
									</FormItem>
								)}
							/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<Textarea placeholder="Provide comments and justification" rows={2} {...field} />
											</FormControl>
										</FormItem>
									)}
								/>
							...
							<Card className="bg-sidebar">
								<CardHeader>
									<CardDescription>{watchedValues.length} attribute(s) available</CardDescription>
								</CardHeader>
								<CardFooter>
