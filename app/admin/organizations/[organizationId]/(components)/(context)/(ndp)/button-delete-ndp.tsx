...
export default function ButtonDeleteNdp({ ndp, organizationId, ...props }: ButtonDeleteNdpProps) {
	const [open, setOpen] = useState(false);
	return (
		<>
			<Button title={ndp ? "Edit Ndp" : "Add Ndp"} onClick={() => setOpen(true)} {...props} />
			<DialogDeleteNdp open={open} setOpen={setOpen} ndp={ndp} organizationId={organizationId} />
		</>
	);
}
...
export function DialogDeleteNdp({ open, setOpen, ndp, organizationId }: DialogDeleteNdpProps) {
