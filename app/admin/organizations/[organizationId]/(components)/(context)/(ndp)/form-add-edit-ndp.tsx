...
export default function FormAddEditNdp({ ndp, open, setOpen, context }: FormAddEditNdpProps) {
	...
	return (
		<ResponsiveDrawer open={open} setOpen={setOpen} title={ndp ? `Update NDP ${ndp.version} version` : "Add a new NDP"}>
			<Form {...form}>
