...
const steps = [
  { id: "particulars", title: "Particulars", icon: Users, description: "Supervisee and Supervisor details" },
  { id: "strategic", title: "Strategic Elements", icon: Target, description: "Mandate, Vision, Mission & Objectives" },
  { id: "performance", title: "Performance Plan", icon: BarChart3, description: "Objectives, KPIs & Scoring" },
  { id: "behavioral", title: "Behavioral Assessment", icon: FileText, description: "Core Values & Attributes" },
]
...
export function BSCForm() {
  ...
  const performanceScore = calculatePerformanceScore(watchedData.performanceObjectives || [])
  const behavioralScore = calculateBehavioralScore(watchedData.behavioralAttributes || [])
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-center mb-2">Staff Balance Score Card (BSC)</h1>
          <p className="text-muted-foreground text-center mb-6">Performance Appraisal System</p>
            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  {currentStep === 1 && <StrategicElementsSection form={form} />}
