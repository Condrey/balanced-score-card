        ...
        <CardContent className="space-y-4">
          <div>
            ...
            {form.formState.errors.strategicElements?.mandate && (
              <p className="text-sm text-destructive mt-1">
                {form.formState.errors.strategicElements.mandate.message}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {form.formState.errors.strategicElements?.vision && (
              <p className="text-sm text-destructive mt-1">
                {form.formState.errors.strategicElements.vision.message}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {form.formState.errors.strategicElements?.mission && (
              <p className="text-sm text-destructive mt-1">
                {form.formState.errors.strategicElements.mission.message}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {form.formState.errors.strategicElements?.goal && (
              <p className="text-sm text-destructive mt-1">
                {form.formState.errors.strategicElements.goal.message}
              </p>
            )}
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="flex gap-2">
            <Input
              ...
              onKeyPress={(e) =>
                e.key === "Enter" && (e.preventDefault(), addNdpProgramme())
              }
            />
          ...
          {form.formState.errors.strategicElements?.ndpProgrammes && (
            <p className="text-sm text-destructive">
              {form.formState.errors.strategicElements.ndpProgrammes.message}
            </p>
          )}
        </CardContent>
      </Card>
            ...
            {objectiveFields.map((field, index) => (
              ...
              >
                <span className="flex-1">
                  {form.watch(`strategicElements.strategicObjectives.${index}`)}
                </span>
                <Button
                  type="button"
                  variant="ghost"
