  ...
  if (!data.supervisee?.name && !data.supervisor?.name) {
    return (
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground text-sm">Start filling out the form to see a preview of your BSC.</p>
        </CardContent>
      </Card>
    )
  }
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {data.performanceObjectives && data.performanceObjectives.length > 0 && (
          <div>
            <h4 className="font-medium text-sm mb-2">Performance Objectives</h4>
